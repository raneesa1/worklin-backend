...
const getAdminTransactionsUseCase = (dependencies) => {
    const { repositories } = dependencies;
    return {
        execute: (adminId) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                return yield repositories.getAdminTransactionsRepository(adminId);
            }
            catch (error) {
